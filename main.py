...
visualisation.select_caract("fichiers_csv/adelie_datas.csv", "longueur_bec", "fichiers_csv/x_longueur_bec.csv")
visualisation.select_caract("fichiers_csv/adelie_datas.csv", "profondeur_bec", "fichiers_csv/y_profondeur_bec.csv")
# On affiche les données sélectionnées
df_x = pandas.read_csv("fichiers_csv/x_longueur_bec.csv")
df_y = pandas.read_csv("fichiers_csv/y_profondeur_bec.csv")
